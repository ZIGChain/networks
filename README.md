...
|-------------|--------|--------------------------|-------------------------------------------------------------------|
| **mainnet** | ✔️     | v1 (1.2.2-patch-1)               | The production-ready ZIGChain mainnet.                            |
| **testnet** | ✔️     | v1 (1.2.2-patch-1)               | The public ZIGChain testnet for developers and ecosystem testing. |
