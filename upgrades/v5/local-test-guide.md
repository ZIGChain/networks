...
|---|---|---|
| Load the mainnet snapshot & run Phase 1 | `v4.1.0` | `binaries/v4.x/` |
| Run the v5 upgrade in Phase 2 | `v5.0.0-rc.1-qa-m3off` | `binaries/v5.0.0-rc.1/` (stale testing build — see note) |
